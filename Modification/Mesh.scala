...
class Mesh[T <: Data : Arithmetic](inputType: T, weightType: T, outputType: T, accType: T,
                                   ...
                                   val meshRows: Int, val meshColumns: Int, has_ternary_weights: Boolean = false) extends Module {
  ...
  val mesh: Seq[Seq[Tile[T]]] = Seq.fill(meshRows, meshColumns)(Module(new Tile(inputType, weightType, outputType, accType, df, tree_reduction, max_simultaneous_matmuls, tileRows, tileColumns, has_ternary_weights)))
